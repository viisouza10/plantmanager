...
import { StyleSheet, View, Image, FlatList,Text, ScrollView, Alert } from 'react-native';
...
export const MyPlants = () =>{
    ...
    useEffect(() =>{
        async function loadStorageData(){
            ...
            setNextWaterd(`Não esqueça de regar a ${plantsStoraged[0].name} daqui ${nextTime}`)
