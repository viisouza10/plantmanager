...
- Inicie a fake api com `yarn server`. Substitua o host pelo seu endereço IP local no package.json. Faça o mesmo no arquivo API dentro de services.
...
Criado por ♥ by Rocketseat 👋🏻 [Participe da nossa comunidade!](https://discordapp.com/invite/gCRAFhc)
E feito por ♥ Vinicius Souza
